...
function id_funds_raised($amount, $post_id, $noformat = false) {
	if ($noformat) {
		...
		return apply_filters('id_display_currency', apply_filters('id_price_format', $amount, $post_id), $amount, $post_id);
	}
}
...
function id_project_goal($goal, $post_id, $noformat = false) {
	if ($noformat) {
		...
		return apply_filters('id_display_currency', apply_filters('id_price_format', $goal, $post_id), $goal, $post_id);
	}
}
